      ...
      <div className="sm:w-[1100px] max-w-none bg-white rounded-lg p-6 border border-gray-300">
          ...
          {formData.portfolio !== "" ? (
            <div className="mb-4">
              <div>
                <label className="block text-[#565656] font-medium mb-1">
                    {currentTexts.portfolio} <span className="text-red-500">*</span>
                </label>
                <div className="flex items-start gap-2 text-sm text-[#B3B3B3] mb-2">
                  <svg
                    width="21"
                  ...
                  <div className="flex-1">{currentTexts.portfolioInfo}</div>
                </div>
              </div>
              <div className="border border-gray-300 rounded-lg p-3 flex flex-wrap items-center gap-4 shadow-sm">
                <div className="flex justify-between items-center w-full gap-4">
            ...
            <div className="mb-4">
              <div>
                ...
                <div className="flex items-start gap-2 text-sm text-[#B3B3B3] mb-2">
                  ...
                  <div className="flex-1">{currentTexts.resumeInfo}</div>
                </div>
              </div>
              <div className="border border-gray-300 rounded-lg p-3 flex flex-wrap items-center gap-4 shadow-sm">
                <div className="flex justify-between items-center w-full gap-4">
            ...
            <div className="mb-4">
              <div>
                ...
                <div className="flex items-start gap-2 text-sm text-[#B3B3B3] mb-2">
                  ...
                  <div className="flex-1">{currentTexts.otherDocumentsInfo}</div>
                </div>
              </div>
              <div className="border border-gray-300 rounded-lg p-3 flex flex-wrap items-center gap-4 shadow-sm">
                <div className="flex justify-between items-center w-full gap-4">
