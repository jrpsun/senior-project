...
const AwardSummary: React.FC<AwardSummaryProps> = ({ awards, isVisible, setIsVisible, setReport }) => {
            ...
            <div className="bg-white shadow-lg rounded-lg w-full max-w-2xl lg:max-w-screen-xl p-3">
                <div className="p-6 bg-white rounded-lg w-full max-w-6xl mx-auto">
                    <div className="flex flex-cols gap-4">
                        ...
                        <ReportProb isVisible={isVisible} problem={texts.comAwardSumTitle} setReport={setReport} reportColumn={"awards"}/> 
                    </div>
