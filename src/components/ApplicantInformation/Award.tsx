  ...
  {/*const checkOCRData = (id, ocrName) => {
    ...
    if (container) {
      ...
      if (ocrName !== userName) {
        setAlertMessage(
          language === "TH"
            ? "ข้อมูลชื่อ-นามสกุลในเอกสารไม่ตรงกับข้อมูลในระบบ กรุณาตรวจสอบและแก้ไขให้ถูกต้อง"
            : "The name in the document does not match the system information. Please check and correct it."
        );
              ...
              <div className='flex flex-col gap-y-5'>
                <div className="w-[330px]">
                  <FormField
                    ...
                    value={container.formData.competitionName}
                    onChange={(value) => handleChange(container.id, "competitionName", value)}
                ...
                <div className="flex flex-col md:flex-row md:space-x-8">
                  <div className="w-[330px]">
                    <CustomSelect
                      ...
                      value={container.formData.competitionYear}
                      onChange={(selectedOption) => handleChange(container.id, "competitionYear", selectedOption ? selectedOption.value : "")}
                  ...
                  <div className="w-[330px]">
                    <CustomSelect
                      ...
                      value={container.formData.competitionLevel}
                      onChange={(selectedOption) => handleChange(container.id, "competitionLevel", selectedOption ? selectedOption.value : "")}
                ...
                <div className="flex flex-col md:flex-row md:space-x-8">
                  ...
                  <div className="w-[350px]">
                    <FormField
                      ...
                      value={container.formData.projectWorks}
                      onChange={(value) => handleChange(container.id, "projectWorks", value)}
