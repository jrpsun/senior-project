        ...
        {!isPrivacyPolicyPage && (
          <div className="flex items-center relative ml-auto">
            ...
            <div className="flex items-center gap-4">
              {/* แสดงไอคอนเสมอ แต่ชื่อผู้ใช้หายไปบนจอเล็ก */}
        ...
        <div className="relative flex items-center gap-2">
          ...
          >
            <button
              ...
              className="flex items-center px-1 py-2 bg-white"
            >
            ...
            {langDropdownOpen && (
              <div className="absolute right-0 mt-2 w-24 bg-white border rounded-[5px] shadow-lg p-2 z-50">
                {["TH", "EN"].map((lang) => (
                  <button
                    key={lang}
