//not use anymore ;; all below for personal testing
'use client';
    ...
    <div>
      ...
      {containers.map(container => (
        <div key={container.id}>
          <div className="flex justify-center pt-10 bg-[#FFFFFF]  mt-6">
            <div className="w-[1100px] max-w-none bg-white rounded-lg p-6 border border-gray-300">
              ...
              <div className="mb-6">
                <h2 className="text-lg font-medium text-gray-800">Certificates or Awards for Talents<span className='text-[#D92D20]'> *</span></h2>
                <div className="text-[#B3B3B3] mt-2">
                  <div className="flex flex-col">
                    <div className="flex items-baseline space-x-2">
                      ...
                      <span>
                        Upload a certificate or awards for talents, one file per entry (PDF format, maximum file size 5 MB)
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className='flex justify-start gap-y-5 flex-col'>
                <div className='flex justify-start gap-x-7'>
                  <div className='flex flex-col'>
                    Talent Type
                    <select defaultValue="Select Talent Type" className='w-[330px] border border-gray-300 rounded-lg px-4 py-2 text-gray-600 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400'>
                      <option value="Select Talent Type" disabled>Select Talent Type</option>
                  ...
                  <div className='flex flex-col'>
                    ...
                    <input
                      type="text"
                      placeholder='Enter Name of Work/Activity'
                  ...
                  <div className='flex flex-col'>
                    Year of Work/Activity
                    <select defaultValue="Select Year of Work/Activity" className='w-[330px] border border-gray-300 rounded-lg px-4 py-2 text-gray-600 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400'>
                      <option value="Select Year of Work/Activity" disabled>Select Year of Work/Activity</option>
                      <option value="opt1">Option 1</option>
                      <option value="opt2">Option 2</option>
                      <option value="opt3">Option 3</option>
                    </select>
                ...
                <div className='flex justify-start gap-x-7'>
                  ...
                  <div className='flex flex-col'>
                    ...
                    <input
                      type="text"
                      placeholder='Enter Link Youtube, Google Drive etc.'
                      className='w-[330px] border border-gray-300 rounded-lg px-4 py-2 text-gray-600 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400'
                    />
                  </div>
                </div>
              ...
              <div className='flex justify-start mt-6'>
                <div className='flex flex-col'>
                  Remark
                  <textarea
                    className="w-[1050px] max-w-none h-[80px] border border-gray-300 rounded-lg p-2 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    placeholder="Provide additional details about the work/activity."
      ...
      <div className="flex justify-center">
        <div className='flex-col'>
          ...
          <button
            className="flex items-center justify-center mt-6 w-[1100px] max-w-none border border-[#008A90] rounded-md py-2 px-4 hover:bg-teal-50 transition"
          ...
          >
            <div className="flex items-center gap-2 text-[#008A90] gap-x-7">
              ...
              <span className="text-[#008A90] font-medium">Add Talent Information</span>
            </div>
          </button>
